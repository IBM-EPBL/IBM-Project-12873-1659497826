...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Job</b> Hunt</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="#candidates">Job Seeker</a>
          </li>
          <li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>Are <strong>YOU</strong> The One? Come And Join Us</h1>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="jonsnow.netai.net"> Job Hunt</a>.</strong> All rights
    reserved.
    </div>
  </footer>
